...
public class CoreAndroid extends CordovaPlugin {
    ...
    class C01463 implements Runnable {
        C01463() {
        }
    ...
    class C01485 extends BroadcastReceiver {
        C01485() {
        }
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        ...
        try {
            if (action.equals("clearCache")) {
                ...
                this.cordova.getActivity().runOnUiThread(new C01441());
    ...
    public void clearCache() {
        this.cordova.getActivity().runOnUiThread(new C01452());
    }

    public void loadUrl(String url, JSONObject props) throws JSONException {
        LOG.m4d("App", "App.loadUrl(" + url + "," + props + ")");
        int wait = 0;
    ...
    public void clearHistory() {
        this.cordova.getActivity().runOnUiThread(new C01463());
    }

    public void backHistory() {
        this.cordova.getActivity().runOnUiThread(new C01474());
    }

    public void overrideBackbutton(boolean override) {
        LOG.m10i("App", "WARNING: Back Button Default Behavior will be overridden.  The backbutton event will be fired!");
        this.webView.setButtonPlumbedToJs(4, override);
    }

    public void overrideButton(String button, boolean override) {
        LOG.m10i("App", "WARNING: Volume Button Default Behavior will be overridden.  The volume event will be fired!");
    ...
    private void initTelephonyReceiver() {
        ...
        this.telephonyReceiver = new C01485();
    ...
    public static Object getBuildConfigValue(Context ctx, String key) {
        ...
        try {
            ...
            LOG.m4d(TAG, "Unable to get the BuildConfig, is this built with ANT?");
            e.printStackTrace();
        } catch (NoSuchFieldException e2) {
            LOG.m4d(TAG, key + " is not a valid field. Check your build.gradle");
        } catch (IllegalAccessException e3) {
            LOG.m4d(TAG, "Illegal Access Exception: Let's print a stack trace.");
            e3.printStackTrace();
        }
        return obj;
    }
