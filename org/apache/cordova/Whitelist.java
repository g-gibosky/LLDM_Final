    ...
    private static class URLPattern {
        ...
        public boolean matches(Uri uri) {
            try {
                ...
                LOG.m4d(Whitelist.TAG, e.toString());
                return false;
            }
        }
    }
        ...
        if (this.whiteList != null) {
            try {
                if (origin.compareTo("*") == 0) {
                    LOG.m4d(TAG, "Unlimited access to network resources");
                    this.whiteList = null;
                    return;
                }
                ...
                if (m.matches()) {
                    ...
                    if ((AndroidProtocolHandler.FILE_SCHEME.equals(scheme) || "content".equals(scheme)) && host == null) {
                        host = "*";
                    }
                ...
                LOG.m6d(TAG, "Failed to add origin %s", origin);
            }
        }
    }
