...
public abstract class Linker {
    ...
    public static class LibInfo implements Parcelable {
        public static final Creator<LibInfo> CREATOR = new C01711();
        @AccessedByNative
        ...
        static class C01711 implements Creator<LibInfo> {
            C01711() {
            }
        ...
        public void writeToParcel(Parcel out, int flags) {
            if (this.mRelroFd >= 0) {
                ...
                try {
                    ...
                    Log.m28e(Linker.TAG, "Can't write LibInfo file descriptor to parcel", e);
                }
            }
        }
    ...
    public static final Linker getInstance() {
        Linker linker;
        boolean isIncrementalInstall = false;
        synchronized (sSingletonLock) {
            if (sSingleton == null) {
                ...
                Log.m29i(TAG, "Using linker: " + sSingleton.getClass().getName(), new Object[0]);
            }
            linker = sSingleton;
        }
        return linker;
    ...
    public static final void setImplementationForTesting(int type) {
        ...
        synchronized (sSingletonLock) {
            ...
            Log.m29i(TAG, "Forced linker: " + sSingleton.getClass().getName(), new Object[0]);
        }
    }
    ...
    protected final void runTestRunnerClassForTesting(int memoryDeviceConfig, boolean inBrowserProcess) {
        ...
        synchronized (this.mLock) {
            ...
            Log.m29i(TAG, "All linker tests passed", new Object[0]);
        }
    }
    ...
    public final void setMemoryDeviceConfigForTesting(int memoryDeviceConfig) {
        boolean z = true;
        assertLinkerTestsAreEnabled();
        boolean z2 = memoryDeviceConfig == 1 || memoryDeviceConfig == 2;
        assertForTesting(z2);
        synchronized (this.mLock) {
    ...
    protected static void loadLinkerJniLibrary() {
        ...
        try {
            ...
            Log.m38w(TAG, "Couldn't load " + libName + ", trying " + libName + ".cr", new Object[0]);
    ...
    public void loadLibraryNoFixedAddress(@Nullable String zipFilePath, String libFilePath) {
        loadLibraryImpl(zipFilePath, libFilePath, false);
    }
