...
public class GamepadList {
    ...
    class C02511 implements InputDeviceListener {
        C02511() {
        }
    ...
    private GamepadList() {
        ...
        this.mInputDeviceListener = new C02511();
    }
    ...
    public static boolean isGamepadEvent(MotionEvent event) {
        return (event.getSource() & InputDeviceCompat.SOURCE_JOYSTICK) == InputDeviceCompat.SOURCE_JOYSTICK;
    }
