...
public class UrlUtilities {
    private static final HashSet<String> ACCEPTED_SCHEMES = CollectionUtil.newHashSet("about", AndroidProtocolHandler.APP_SCHEME, "content", "data", AndroidProtocolHandler.FILE_SCHEME, "http", "https", "javascript");
            ...
            for (ResolveInfo resolveInfo : handlers) {
                ...
                if (!(filter == null || filter.countDataAuthorities() == 0 || filter.countDataPaths() == 0)) {
                    ...
                    if (activityInfo == null) {
                        continue;
                    } else if (activityInfo.packageName.equals(packageName)) {
                        return true;
                    }
                }
            }
