...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C00241();
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C03892();

    static class C00241 implements ThreadFactory {
    ...
    class C03892 extends WorkerRunnable<Params, Result> {
        C03892() {
        }
