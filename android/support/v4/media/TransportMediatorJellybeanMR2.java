...
class TransportMediatorJellybeanMR2 {
    OnAudioFocusChangeListener mAudioFocusChangeListener = new C00634();
    boolean mAudioFocused;
    final AudioManager mAudioManager;
    final Context mContext;
    boolean mFocused;
    final OnGetPlaybackPositionListener mGetPlaybackPositionListener = new C00645();
    final Intent mIntent;
    final BroadcastReceiver mMediaButtonReceiver = new C00623();
    PendingIntent mPendingIntent;
    int mPlayState = 0;
    final OnPlaybackPositionUpdateListener mPlaybackPositionUpdateListener = new C00656();
    final String mReceiverAction;
    final IntentFilter mReceiverFilter;
    RemoteControlClient mRemoteControl;
    final View mTargetView;
    final TransportMediatorCallback mTransportCallback;
    final OnWindowAttachListener mWindowAttachListener = new C00601();
    final OnWindowFocusChangeListener mWindowFocusListener = new C00612();

    class C00601 implements OnWindowAttachListener {
        C00601() {
        }
    ...
    class C00612 implements OnWindowFocusChangeListener {
        C00612() {
        }
    ...
    class C00623 extends BroadcastReceiver {
        C00623() {
        }
    ...
    class C00634 implements OnAudioFocusChangeListener {
        C00634() {
        }
    ...
    class C00645 implements OnGetPlaybackPositionListener {
        C00645() {
        }
    ...
    class C00656 implements OnPlaybackPositionUpdateListener {
        C00656() {
        }
