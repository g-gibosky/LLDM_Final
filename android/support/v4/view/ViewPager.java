...
public class ViewPager extends ViewGroup {
    ...
    class C04084 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C04084());
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (i = 0; i < size; i++) {
            ...
            if (child.getVisibility() != 8) {
                ...
                if (lp != null && lp.isDecor) {
                    ...
                    if (consumeVertical) {
                        widthMode = PageTransition.CLIENT_REDIRECT;
                    } else if (consumeHorizontal) {
                        heightMode = PageTransition.CLIENT_REDIRECT;
                    }
        ...
        this.mChildWidthMeasureSpec = MeasureSpec.makeMeasureSpec(childWidthSize, PageTransition.CLIENT_REDIRECT);
        this.mChildHeightMeasureSpec = MeasureSpec.makeMeasureSpec(childHeightSize, PageTransition.CLIENT_REDIRECT);
        this.mInLayout = true;
        populate();
        ...
        for (i = 0; i < size; i++) {
            ...
            if (child.getVisibility() != 8) {
                lp = (LayoutParams) child.getLayoutParams();
                if (lp == null || !lp.isDecor) {
                    child.measure(MeasureSpec.makeMeasureSpec((int) (((float) childWidthSize) * lp.widthFactor), PageTransition.CLIENT_REDIRECT), this.mChildHeightMeasureSpec);
                }
            }
        }
    }
                ...
                if (!lp.isDecor) {
                    ...
                    if (ii != null) {
                        ...
                        if (lp.needsMeasure) {
                            ...
                            child.measure(MeasureSpec.makeMeasureSpec((int) (((float) childWidth) * lp.widthFactor), PageTransition.CLIENT_REDIRECT), MeasureSpec.makeMeasureSpec((height - paddingTop) - paddingBottom, PageTransition.CLIENT_REDIRECT));
                        }
                        child.layout(childLeft, childTop, child.getMeasuredWidth() + childLeft, child.getMeasuredHeight() + childTop);
                    }
                }
