...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C00222();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C00211();
    ...
    class C00222 implements OnItemClickListener {
        C00222() {
        }
